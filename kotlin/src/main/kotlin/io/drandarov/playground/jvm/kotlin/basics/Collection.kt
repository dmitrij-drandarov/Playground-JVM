...
@file:Suppress("UNUSED_VARIABLE", "USELESS_IS_CHECK")
...
fun main(args: Array<String>) {
    ...
    */
    ...
    // ----- CLASSES -----
    // Create an io.drandarov.playground.jvm.kotlin.basics.Animal object
    ...
    // ----- INHERITANCE -----
    // Create a class io.drandarov.playground.jvm.kotlin.basics.Dog that inherits from
    // the io.drandarov.playground.jvm.kotlin.basics.Animal class
    ...
    // ----- INTERFACES -----
    // Create a io.drandarov.playground.jvm.kotlin.basics.Bird object that implements the
    // io.drandarov.playground.jvm.kotlin.basics.Flyable interface
    ...
    // a null assignment
    println("NullVal3 is: ${try { nullVal2!!.length } catch (e: NullPointerException) { null }}")
...
open class Animal(val name: String, var height: Double, var weight: Double) {
    ...
    init {
        ...
        require(!name.matches(regex)) { "io.drandarov.playground.jvm.kotlin.basics.Animal Name can't Contain Numbers" }
...
class Dog(
    ...
    // Overriding io.drandarov.playground.jvm.kotlin.basics.Animal method
